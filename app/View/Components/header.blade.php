            ...
            <ul class="nav__list grid">
                ...
                <li class="nav__item">
                    <a href="employers" class="nav__link">
                        <i class="uil uil-user nav__icon"></i> Employers
                    </a>
                </li>

                <li class="nav__item">
                    <a href="job_seekers" class="nav__link">
                        <i class="uil uil-user nav__icon"></i> Job Seekers
                    </a>
                </li>

                <li class="nav__item">
                    <a href="book_online" class="nav__link">
                        <i class="uil uil-user nav__icon"></i> Book Online
                    </a>
                </li>

                <li class="nav__item">
                    <a href="program_list" class="nav__link">
                        <i class="uil uil-user nav__icon"></i> Program List
                    </a>
                </li>
